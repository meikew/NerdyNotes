...
public:
  ...
  bool displayimage(wxScrolled<wxPanel>* firstpanel, wxFlexGridSizer * fgs, int desiredwidth, bool rightaligned,Knomegui * kg, bool provideenlargebutton);//returns true if the file exists and false otherwise
